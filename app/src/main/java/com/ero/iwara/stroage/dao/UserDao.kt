...
@Dao
interface UserDao: BaseDao<UserBase> {
    ...
    suspend fun upsert(username: String, password: String, token: String, accessToken: String): Long {
        val exist = getUserByUsername(username)
